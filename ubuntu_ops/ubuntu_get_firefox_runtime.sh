...
# get list of firefox relative 
function get_process_firefox (){
ps -ef | grep firefox
 }
...
function get_hierarchy_process_firefox() {
ps -f --forest -C firefox
 }
...
function get_process_firefox_elapsed_time(){
ps -eo pid,cmd,etime | grep firefox/firefox 
}
...
echo ''
echo 'GET list of firefox relative ... '
echo ''
get_process_firefox 
echo '=============='
echo 'SHOW running process hierarchy ...'
echo ''
get_hierarchy_process_firefox
echo '=============='
echo 'SHOW running process with elapsed time ...'
echo ''
get_process_firefox_elapsed_time
